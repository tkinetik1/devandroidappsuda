...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (2) - tf Create a method called makeGithubSearchQuery
    ...
    // TODO (3) - tf Within this method, build the URL with the text from the EditText and set the built URL to the TextView
