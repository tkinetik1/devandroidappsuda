...
public class MainActivity extends AppCompatActivity {
    ...
    // Do 2 - 7 in menu.xml ///////////////////////////////////////////////////////////////////////
    // TODO (2) tf Create a menu xml called 'main.xml' in the res->menu folder
    // TODO (3) tf Add one menu item to your menu
    // TODO (4) tf Give the menu item an id of @+id/action_search
    // TODO (5) tf Set the orderInCategory to 1
    // TODO (6) tf Show this item if there is room (use app:showAsAction, not android:showAsAction)
    // TODO (7) tf Set the title to the search string ("Search") from strings.xml
    // Do 2 - 7 in menu.xml ///////////////////////////////////////////////////////////////////////
    ...
    // Override onCreateOptionsMenu from the Superclass
    // TODO (9) Within onCreateOptionsMenu, use getMenuInflater().inflate to inflate the menu
    // inflate the menu by calling getMenuInflater().inflate(R.menu.main, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (menuItemThatWasSelected == R.id.action_search) {
            ...
            String message = "Search Confirmed";
