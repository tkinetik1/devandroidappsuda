...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Toast error = Toast.makeText(getContext(), "Please select a number between 0.1 and 3", Toast.LENGTH_SHORT);
                ...
                //Double check that the preference is the size preference with if try if catch
        ...
        if (preference.getKey().equals(sizeKey)) {
            ...
            try {
                ...
                //If the number is outside of the range, show Toast error.
                if (size > 3 || size <= 0) {
                    error.show();
                    return false;
                }
            } catch (NumberFormatException nfe) {
                // If whatever the user entered can't be pased to a number, show Toast error.
                error.show();
                return false;
            }
        }
