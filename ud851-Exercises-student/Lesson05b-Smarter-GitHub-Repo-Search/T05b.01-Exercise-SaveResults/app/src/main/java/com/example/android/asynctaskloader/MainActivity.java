...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RAW_JSON_KEY = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            String rawJsonSearchResults = savedInstanceState.getString(SEARCH_RAW_JSON_KEY);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String lifecycleDisplayTextViewContents = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RAW_JSON_KEY, lifecycleDisplayTextViewContents);

        String rawJsonSearchResults = mSearchResultsTextView.getText().toString();

        outState.putString(SEARCH_RAW_JSON_KEY, rawJsonSearchResults);
