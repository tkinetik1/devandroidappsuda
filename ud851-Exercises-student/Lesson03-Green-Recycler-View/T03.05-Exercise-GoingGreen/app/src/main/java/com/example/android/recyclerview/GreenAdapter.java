...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // TODO (8) Add a private static int called viewHolderCount that will hold the total number of ViewHolders that are created -tf
    ...
    public GreenAdapter(int numberOfItems) {
        ...
        // TODO (9) When a new GreenAdapter is created, set the viewHolderCount to 0 -tf ?
        viewHolderCount = 0;
    }
