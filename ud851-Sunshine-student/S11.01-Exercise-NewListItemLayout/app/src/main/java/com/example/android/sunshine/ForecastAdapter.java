...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        // Set the Weather Icon based on weatherConditionId
        ...
        // Display and set friendly date string
        forecastAdapterViewHolder.currentDateView.setText(dateString);


         /* Use the weatherId to obtain the proper description */
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, weatherId);
        String descriptionA11y = mContext.getString(R.string.a11y_forecast, description);
        forecastAdapterViewHolder.weatherDescriptionView.setText(description);
        forecastAdapterViewHolder.weatherDescriptionView.setContentDescription(descriptionA11y);
        ...
        forecastAdapterViewHolder.highTemperatureView.setContentDescription(highA11y);
        ...
        forecastAdapterViewHolder.lowTemperatureView.setContentDescription(lowA11y);
    }
...
//      TODO (4) Replace the weatherSummary TextView with individual weather detail TextViews
        ...
        final TextView weatherDescriptionView;
...
//          TODO (6) Get references to all new views and delete this line
            ...
            currentDateView = (TextView) view.findViewById(R.id.date);
            weatherDescriptionView = (TextView) view.findViewById(R.id.weather_description);
