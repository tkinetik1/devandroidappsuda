...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
             // TODO (19) As soon as the data is finished loading, hide the loading indicator -tf

            mProgressBar.setVisibility(ProgressBar.INVISIBLE);

            if (weatherData != null) {
                // TODO (11) If the weather data was not null, make sure the data view is visible -tf
                showWeatherDataView();
                /*
            ...
            // TODO (10) If the weather data was null, show the error message -tf
