...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler {
    ...
    public void onClick(String weatherForDay) {
        ...
        // Store DetailActivity.class in a Class object called detailedActivity - tf
        Class detailedActivity = DetailActivity.class;

        // Create an Intent to start DetailedActivity
        Intent startDetailActivity = new Intent(context, detailedActivity);

        // Replace the Toast with code to start DetailActivity
